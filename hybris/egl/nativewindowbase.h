...
protected:
	...
	virtual int dequeueBuffer_DEPRECATED(BaseNativeWindowBuffer **buffer) = 0;
	virtual int lockBuffer_DEPRECATED(BaseNativeWindowBuffer *buffer) = 0;
	virtual int queueBuffer_DEPRECATED(BaseNativeWindowBuffer *buffer) = 0;
	virtual int cancelBuffer_DEPRECATED(BaseNativeWindowBuffer *buffer) = 0;
